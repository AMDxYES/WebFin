...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="gv_data" runat="server" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" OnRowCommand="gv_data_RowCommand">
                <Columns>
                    <asp:ButtonField ButtonType="Button" CommandName="sel" Text="詳細資料" />
                </Columns>
